...
class TestTrustedSenders:
    def test_plain_address_accepted(self):
        with patch("app.safety.email_guard._get_trusted_domains", return_value=frozenset(["company.com"])):
    ...
    def test_multiple_trusted_domains(self):
        ...
        with patch("app.safety.email_guard._get_trusted_domains", return_value=frozenset(["company.com", "partner.org"])):
...
class TestUntrustedSenders:
    ...
    def test_no_trusted_domains_configured(self):
        ...
        with patch("app.safety.email_guard._get_trusted_domains", return_value=frozenset()):
