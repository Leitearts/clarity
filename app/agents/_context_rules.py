...
def context_rules(
    request: AgentRequest, context: PatientContext, agent
) -> AgentResponse:
    findings = []
    multiplier = 1.0
    ...
    active = [
        c
        for c in context.comorbidities
    ...
    reasoning = (
        f"Patient {context.age}y {context.sex}, {context.care_setting}. "
