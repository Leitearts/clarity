...
HIGH_ACUITY_ICD_PREFIXES = {
    "I21": "Acute myocardial infarction", "I22": "Subsequent MI",
    "I63": "Cerebral infarction", "A41": "Sepsis",
    "J96": "Respiratory failure", "N17": "Acute kidney injury",
    "K92": "GI hemorrhage", "I50": "Heart failure",
    "J18": "Pneumonia",
}
...
def diagnose_rules(request: AgentRequest, diagnoses: list[Diagnosis], agent) -> AgentResponse:
    findings = []
    risk_score = 0.0
    acuity_hits = []
    ...
    for pair in CONFLICTING_PAIRS:
        if pair[0] in codes_present and pair[1] in codes_present:
            findings.append(Finding(code="CONFLICTING_DIAGNOSES",
    ...
    if rapid:
        ...
        findings.append(Finding(code="RAPID_ONSET",
    ...
    return agent._build_response(request=request,
