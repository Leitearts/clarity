...
CLINICAL_ACTIONS: dict[RiskLevel, dict] = {
    RiskLevel.LOW: {
        "urgency": "routine", "review_window": "next scheduled visit",
        "notify": [], "escalate": False,
        "description": "No immediate action required. Standard monitoring.",
    },
    RiskLevel.MEDIUM: {
        "urgency": "within 24 hours", "review_window": "24h",
        "notify": ["attending physician"], "escalate": False,
        "description": "Schedule clinical review. Flag for attending.",
    },
    RiskLevel.HIGH: {
        "urgency": "within 1 hour", "review_window": "1h",
        "notify": ["attending physician", "charge nurse"], "escalate": True,
        "description": "Urgent review required. Consider intervention.",
    },
    RiskLevel.CRITICAL: {
        "urgency": "immediate", "review_window": "now",
